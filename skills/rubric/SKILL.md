...
2. Hand the rubric and the work to a fresh subagent that has seen neither the making of it nor this conversation. It marks each criterion pass or fail with the evidence, and names what it would change. The maker never judges its own taste.
